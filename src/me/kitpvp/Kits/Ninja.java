...
public class Ninja implements CommandExecutor, Listener {
	...
	//
	//
	// This kit has not been edited from /pvp. \\
	//
	//
	//
	//
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		if(commandLabel.equalsIgnoreCase("ninja") && sender.hasPermission("KitPvP.ninja")){
	...
	inv.clear();
			...
			String ninja = plugin.getConfig().getString("ninjamsg");
String prefixmsg = plugin.getConfig().getString("prefixmsg");
			
			p.sendMessage(ChatColor.GOLD + "[" + ChatColor.RED + "" + prefixmsg + ChatColor.GOLD + "] " + ChatColor.GOLD + " " + ninja);
